...
//     async function fetchData() {
//       const ranking = await fetchReturnRateRank();
//       const totalData = ranking.map((item, index) => [index + 1, item.name, item.sectorNames[0], item.returnRate]);

//       const top3 = ranking.slice(0, 3);
//       const top3Data = top3.map((item, index) => [index + 1, item.name, item.firm, item.returnRate + "%"]);
