...
import "./Common.css";
import RowReport2 from "./RankRowReport2"; // Row 컴포넌트 불러오기
import { MdFirstPage, MdLastPage } from "react-icons/md";
import { MdOutlineFirstPage } from "react-icons/md";

export default function RankReport2({ column, data }) {
  ...
  return (
    <div ref={cardRef} className="rankCardReport">
      <div className="rankContainer">
        ...
        {paginatedData.map((row, rowIndex) => (
          <RowReport2 key={rowIndex} row={row} column={column} />
        ))}
